                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">Ini adalah email forgot password anda di Website Beehive,
                                    Silahkan klik button berikut untuk melanjutkan</p>
                            </td>
                        </tr>
                        <!-- end copy -->
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#ffffff" style="padding: 12px;">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center" bgcolor="#e28743" style="border-radius: 6px;">
                                                        <a href="{{!!$link!!}}" target="_blank"
                                                            style="display: inline-block; padding: 16px 36px; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Ganti Password!
                                                            </a>
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">Cheers,<br> Beehive</p>
                            </td>
                        </tr>
                        <!-- end copy -->
                        ...
                        <tr>
                            <td align="center" bgcolor="#e9ecef"
                                ...
                                <p style="margin: 0;">You received this email because we received a request for
                                   forgot password. If you didn"t request any registration you can safely
                                    delete this email.</p>
                            </td>
                        </tr>
                        <!-- end permission -->
