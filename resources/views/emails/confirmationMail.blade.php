                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                        ...
                        <tr>
                            <td align="left" bgcolor="#ffffff"
                                ...
                                <p style="margin: 0;">Ini adalah email verifikasi pendaftaran anda di Beehive,
                                                ...
                                                <tr>
                                                    <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                        <a href="{{!!$link!!}}" target="_blank"
                                                            style="display: inline-block; padding: 16px 36px; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Verifikasi
                                                            Sekarang!</a>
                                                    </td>
                                                </tr>
                                            </table>
                        ...
                        <tr>
                            <td align="center" bgcolor="#e9ecef"
                                ...
                                <p style="margin: 0;">You received this email because we received a request for
                                    registration for your account. If you didn"t request any registration you can safely
                                    delete this email.</p>
                            </td>
                        </tr>
                        <!-- end permission -->
