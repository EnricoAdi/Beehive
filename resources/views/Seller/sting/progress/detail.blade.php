...
@section('title', 'Sting Detail Beeworker Beehive')

@section('content')
    <a href="{{ url('/seller/order') }}" class="btn btn-secondary w-28 ml-10 mt-4 shadow-md">Back</a>
    <div class="p-10 flex gap-5 w-full text-base-100">
        <div class="w-2/3  shadow-gray-300 rounded-lg flex flex-col">
            ...
            <div class="p-5 bg-accent shadow-lg w-full rounded-b-lg text-black flex flex-col gap-5">
                ...
                <div>
                    <div class="text-lg font-semibold">Farmer : {{ $order->farmer->NAMA }} ({{ $order->farmer->EMAIL }})
                    </div>
            ...
            <div class="bg-accent h-fit rounded-lg shadow-lg shadow-gray-300 p-5 sticky top-0 text-black mt-3">
                <div class="flex flex-col gap-3 h-1/2">
                    ...
                    @if ($order->FILENAME_FINAL != '')
                        <a href="{{ url("/seller/sting/detail/download/$order->FILENAME_FINAL") }}" target="_blank"
                    ...
                    @if ($waiting || $order->STATUS > 1)
                        <div class="btn btn-secondary" disabled>Deliver First Order Sting</div>
                    @else
                        <div class="btn btn-secondary" data-modal-toggle="detail-modal-submission">Deliver First Order Sting
                        </div>
                    @endif
                    ...
                    @forelse ($complains as $c)
                        <div class="mt-4">
                            ...
                            @if ($c->FILE_REVISION != '')
                                ...
                                <a href="{{ url("/seller/sting/detail/download/$c->FILE_REVISION") }}" target="_blank"
    ...
    <div id="detail-modal-revision" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative bg-base-100  rounded-lg shadow-2xl dark:bg-gray-700">
                ...
                <div class="py-6 px-6 lg:px-8 text-black">
                    <form action="{{ url("/seller/sting/detail/revision/$id") }}" method="post" class=""
