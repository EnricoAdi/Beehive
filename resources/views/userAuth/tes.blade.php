...
<body class="">
    <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5 h-screen ">
        <div class="bg-accent shadow-2xl text-gray-500 rounded-3xl h-full  w-full overflow-hidden" style="max-width:1000px">
            <div class="md:flex w-full">
                ...
                <form class="w-full md:w-1/2 py-10 px-5 md:px-10" method="post" action="">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button
                                    class="inline-block w-full px-5 py-2 text-lg font-medium text-center text-white transition duration-200 bg-blue-600 rounded-lg hover:bg-blue-700 ease mt-5"
