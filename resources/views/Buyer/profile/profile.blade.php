...
@section('content')
    <div class="h-full">
        <h1 class="text-3xl ml-20 mt-5 font-semibold block">{{$user->SUBSCRIBED==0?"Farmer":"QueenBee"}}'s Profile</h1>
        ...
        <div class="border-b-2 block md:flex">
            ...
            <div class="w-full md:w-2/5 p-4 sm:p-6 lg:p-8 bg-neutral shadow-md ">
                ...
                <div class="w-full p-8 mx-2 flex flex-col justify-center">
                    ...
                    @else
                        ...
                        @endif
                    @endif
                    <a href={{ url('buyer/profile/picture') }} class="btn btn-accent capitalize mt-2 ml-2 w-56">Change
                        Profile Picture</a>
                </div>
            ...
            <div class="w-full md:w-3/5 p-8 bg-neutral lg:ml-4 shadow-md">
                ...
                <a href="{{ url('/buyer/profile/password') }}">
