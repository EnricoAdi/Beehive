...
@section('title', 'Sting Review Farmer Beehive')
        ...
        <div class="mt-8">
            <form action="" method="post">
                ...
                <div class="block px-6 pb-6 rounded-lg shadow-lg bg-secondary max-w-md mt-4 w-96">
                    <div class="text-lg font-bold text-center mb-6 text-whiteColor"><br> Rate and Review Sting!</div>
                    <div class="flex">
            ...
            <a class="inline-block w-full px-5 py-2 text-lg font-medium text-center text-white transition duration-200 bg-red-500 rounded-lg hover:bg-error ease mt-3"
                data-rounded="rounded-lg" href="{{ url("buyer/sting/ordered/detail/$id") }}">
                Back
            </a>
        </div>
    </div>
